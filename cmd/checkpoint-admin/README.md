...
```shell
go get github.com/DxChainNetwork/dxc/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/DxChainNetwork/dxc/blob/master/params/config.go#L251).*
