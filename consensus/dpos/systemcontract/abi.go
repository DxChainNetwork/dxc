...
const ValidatorsABI = `[
    ...
    },
    {
      ...
      "name": "LogUpdateValidatorDeposit",
      "type": "event"
    },
    {
      "anonymous": false,
    ...
    {
      "inputs": [],
      "name": "CancelQueueValidatorsLength",
      "outputs": [
        {
          "internalType": "uint256",
          "name": "",
      ...
      "outputs": [
        {
          ...
          "internalType": "struct Validators.ValUpdateRate[]",
          "name": "",
          "type": "tuple[]"
        }
      ],
      ...
      "outputs": [
        {
          "components": [
            ...
            {
              "internalType": "uint256",
              "name": "unstakeLockingEndBlock",
              "type": "uint256"
            },
            {
              "internalType": "uint256",
              "name": "rateSettLockingEndBlock",
              "type": "uint256"
            }
          ],
          "internalType": "struct Validators.Validator",
          "name": "",
          "type": "tuple"
        }
      ],
